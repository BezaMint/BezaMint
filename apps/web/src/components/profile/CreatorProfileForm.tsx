    ...
    <form onSubmit={handleSubmit} className="space-y-5">
      <div className="flex items-center justify-between">
        ...
        <button
          type="button"
          onClick={onCancel}
          className="p-2 rounded-lg text-gray-500 hover:text-gray-300 hover:bg-bezamint-muted"
        >
      ...
      <ImagePreview
        ...
        onChange={(v) => update('avatarUri', v)}
        placeholder="https://ipfs.io/ipfs/avatar..."
        required
      />
      ...
      <ImagePreview
        ...
        onChange={(v) => update('bannerUri', v)}
        placeholder="https://ipfs.io/ipfs/banner..."
      />

      {/* Social Links */}
      <SocialLinkEditor links={form.socialLinks} onChange={(v) => update('socialLinks', v)} />
